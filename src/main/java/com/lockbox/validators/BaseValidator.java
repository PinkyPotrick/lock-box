...
/**
 * Base validator class that provides common validation methods. This class is meant to be extended by specific entity
 * validators.
 */
public abstract class BaseValidator {
    ...
    /**
     * Creates a new validator for the specified entity type.
     * 
